...
public class ExecutionVertex implements Serializable {
  ...
  public ExecutionVertex(int jobVertexId,
                         ...
                         long buildTime) {
    this.vertexId = generateExecutionVertexId(jobVertexId,
      executionJobVertex.getParallelism(), index);
  ...
  private int generateExecutionVertexId(int jobVertexId, int parallelism, int index) {
    int id = jobVertexId * (int) (Math.pow(10, String.valueOf(parallelism).length())) + index;
    return id;
  }
